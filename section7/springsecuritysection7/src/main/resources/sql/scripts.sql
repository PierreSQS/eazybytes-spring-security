drop database if exists eazybytessection7db;
create database eazybytessection7db;

use eazybytessection7db;

-- THE CUSTOMER AS IMPLEMENTED IN SECT3-CHAP27 !!!!!!!!!
/*
...
-- THE CUSTOMER AS IMPLEMENTED IN SECT6-CHAP48 !!!!!!!!!
CREATE TABLE `customer` (
...
`closing_balance`, `create_dt`)  VALUES (UUID(), 1865764534, 1, DATE_SUB(CURDATE(),INTERVAL 8 DAY), 'Coffee Shop', 'Withdrawal', 30,34500,DATE_SUB(CURDATE(),INTERVAL 8 DAY));
...
INSERT INTO `loans` ( `customer_id`, `start_dt`, `loan_type`, `total_loan`, `amount_paid`, `outstanding_amount`, `create_dt`)
 VALUES ( 1, '2022-03-13', 'Home', 200000, 50000, 150000, '2022-03-13');

INSERT INTO `loans` ( `customer_id`, `start_dt`, `loan_type`, `total_loan`, `amount_paid`, `outstanding_amount`, `create_dt`)
 VALUES ( 1, '2022-04-06', 'Vehicle', 40000, 10000, 30000, '2022-04-06');
...
'2022-03-14', '2022-11-30', CURDATE(), null);

INSERT INTO `notice_details` ( `notice_summary`, `notice_details`, `notic_beg_dt`, `notic_end_dt`, `create_dt`, `update_dt`)
VALUES ('Net Banking Offers', 'Customers who will opt for Internet banking while opening a saving account will get a $50 amazon voucher',
'2022-03-14', '2022-12-05', CURDATE(), null);

INSERT INTO `notice_details` ( `notice_summary`, `notice_details`, `notic_beg_dt`, `notic_end_dt`, `create_dt`, `update_dt`)
VALUES ('Mobile App Downtime', 'The mobile application of the EazyBank will be down from 2AM-5AM on 12/05/2022 due to maintenance activities',
'2022-03-14', '2022-12-01', CURDATE(), null);
...
'2022-03-14', '2022-12-08', CURDATE(), null);

INSERT INTO `notice_details` ( `notice_summary`, `notice_details`, `notic_beg_dt`, `notic_end_dt`, `create_dt`, `update_dt`)
VALUES ('Launch of Millennia Cards', 'Millennia Credit Cards are launched for the premium customers of EazyBank. With these cards, you will get 5% cashback for each purchase',
'2022-03-14', '2022-11-28', CURDATE(), null);

INSERT INTO `notice_details` ( `notice_summary`, `notice_details`, `notic_beg_dt`, `notic_end_dt`, `create_dt`, `update_dt`)
VALUES ('COVID-19 Insurance', 'EazyBank launched an insurance policy which will cover COVID-19 expenses. Please reach out to the branch for more details',
'2022-03-14', '2022-12-31', CURDATE(), null);
